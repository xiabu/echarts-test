...
.main {
  background: url(./images/index2/53bg.png) no-repeat;
  background-size: 100%;
  width: 100vw;
  height: 100vh;
  padding: 0 2.5%;
...
.main .top5 .top5-title {
  width: 100%;
  height: 10%;
  background: url(./images/index2/title.png) no-repeat center;
  background-size: 100%;
  color: #fff;
  text-align: center;
  display: table;
...
.main .top5 .top5-content ul li .li-content {
  ...
  height: 100%;
  margin-left: 5%;
  background: url(./images/index2/border.png) no-repeat center;
...
.main .top5 .top5-content ul li .cicle {
  ...
  width: 1.7rem;
  height: 1.7rem;
  background: url(./images/index2/green.png) no-repeat center;
  background-size: 100%;
  left: 0;
  bottom: 0;
}
.main .top5 .top5-content ul li:nth-of-type(1) .li-content {
  background: url(./images/index2/border2.png) no-repeat center;
  background-size: contain;
}
.main .top5 .top5-content ul li:nth-of-type(1) .cicle {
  background: url(./images/index2/orange.png) no-repeat center;
  background-size: 100%;
}
.main .total {
  width: 100%;
...
.main .total .sphere .sphere-bg {
  ...
  width: 100%;
  height: 100%;
  background: url(./images/index2/53earth.png) no-repeat center;
  background-size: contain;
}
.main .total .sphere .sum {
  ...
  width: 100%;
  height: 100%;
  background: url(./images/index2/53cloud.png) no-repeat center;
  background-size: 55%;
}
...
.main .total .cicle3 {
  width: 10rem;
  height: 10rem;
  background: url(./images/index2/circle.png) no-repeat center;
  background-size: 100%;
  position: absolute;
  top: 45%;
  left: 50%;
...
.main .total .cicle4 {
  ...
  left: 50%;
  transform-style: preserve-3d;
  background: url(./images/index2/53gqright.png) no-repeat center;
  background-size: 100%;
  transform: translateX(-50%) rotateX(75deg);
...
.main .total .cicle5 {
  ...
  left: 50%;
  transform-style: preserve-3d;
  background: url(./images/index2/53gqleft.png) no-repeat center;
  background-size: 100%;
  transform: translateX(-50%) rotateX(75deg);
...
.main .total .cicle6 {
  ...
  left: 50%;
  transform-style: preserve-3d;
  background: url(./images/index2/535gqbottomright.png) no-repeat center;
  background-size: 100%;
  transform: translateX(-50%) rotateX(75deg);
  animation: rotate3 2s linear infinite;
}
.main .total .cicle7 {
  ...
  left: 50%;
  transform-style: preserve-3d;
  background: url(./images/index2/53gqbottomleft.png) no-repeat center;
  background-size: 100%;
  transform: translateX(-50%) rotateX(75deg);
  animation: rotate4 2s linear infinite;
}
...
.main .total .cicle8 {
  background: url(./images/index2/circle1.png) no-repeat;
  background-size: 100%;
  animation: rotate5 20s linear infinite;
  color: #f29701;
}
.main .total .cicle9 {
  background: url(./images/index2/circle2.png) no-repeat;
  background-size: 100%;
...
.main .analyse .execution {
  width: 100%;
  height: 30%;
  background: url(./images/index2/execution.png) no-repeat;
  background-size: contain;
  overflow: hidden;
  position: relative;
}
...
.main .analyse .execution .cicle2 {
  ...
  width: 4rem;
  height: 4rem;
  background: url(./images/index2/2222.png) no-repeat center;
  background-size: 100%;
  transform-style: preserve-3d;
...
.bottom {
  width: 100%;
  height: 10%;
  background: url(./images/index2/53bottomsjbg.png) no-repeat bottom center;
  background-size: 100%;
  text-align: center;
}
.bottom h5 {
